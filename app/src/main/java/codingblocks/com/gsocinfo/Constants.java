...
public class Constants {
    ...
    public static ArrayList<String> getStudentsQuestions() {
        ArrayList<String> studentQuestions = new ArrayList<>();

        studentQuestions.add("When can students apply for GSoC?");
        studentQuestions.add("What programming language(s) should I know to participate in GSoC?");
        studentQuestions.add("Can I submit more than one proposal?");
        studentQuestions.add("Can students already working on an open source project continue to work on it as part of GSoC?");
        studentQuestions.add("Can a group submit a proposal together to work on a single project?");
        studentQuestions.add("Should I send proposals directly to the mentoring organizations?");
        studentQuestions.add("What are the eligibility requirements for participation?");
        studentQuestions.add("What forms will I need to provide?");
        studentQuestions.add("I am an accepted student in the United States on an F1 visa. How do I get authorization to participate?");
        studentQuestions.add("How do I know if my school is “accredited”?");
        studentQuestions.add("I graduate in the middle of the program. Can I still participate?");
        studentQuestions.add("Do I get paid for participating in GSoC? ");
        studentQuestions.add("Will I get paid even if the organization does not use my code?");
        studentQuestions.add("What does a good student proposal look like?");
        studentQuestions.add("How much time does GSoC participation take?");
        studentQuestions.add("Can I earn course credit for participating in GSoC?");
    ...
    public static ArrayList<String> getStudentsAnswers() {
        ArrayList<String> studentAnswers = new ArrayList<>();

        studentAnswers.add("Please see the <a href=\"https://developers.google.com/open-source/gsoc/timeline\">program timeline</a>  for more detailed information.");

        studentAnswers.add("The programming language you need to know depends on which organization you are\n" +
                "interested in working with. You should be familiar with the programming\n" +
                "language(s) used by that organization.");


        studentAnswers.add("Yes, each student may submit up to five proposals. However, only one per student\n" +
                "may be accepted. No more than one proposal per student will be accepted, no\n" +
                "matter how many proposals you submit.");


        studentAnswers.add("Yes, but students should be sure to note their previous relationship with the\n" +
                "project in their proposals.");


        studentAnswers.add("No, only an individual may work on a given project.");


        studentAnswers.add("No, all proposals should be submitted to the program site. Proposals submitted\n" +
                "outside of the Google Summer of Code program site ");

        studentAnswers.add("You must be at least 18 years of age\n " +
        ...
        studentAnswers.add("All applicants will need to provide  <a href=\"https://developers.google.com/open-source/gsoc/help/proof-of-enrollment\">proof of enrollment</a>  <a href=\"#accredited\">accredited</a> educational institution.");

        studentAnswers.add("Accepted participants will need to provide appropriate <a href=\"https://developers.google.com/open-source/gsoc/help/tax-forms\">tax forms</a>");

        studentAnswers.add("Please talk to your school's international student affairs office for more details. In the past, students on an F1 visa have participated in GSoC through\n" +
        ...
        studentAnswers.add("You can learn more about accreditation for universities  <a href=\"http://en.wikipedia.org/wiki/Higher_education_accreditation\">here.</a>\n" +
        ...
        studentAnswers.add("Yes, as long as you are accepted into or enrolled in a college or university program as of the date accepted students are announced, you are eligible to participate in the program. Students must provide proof of enrollment during the proposal period.");

        studentAnswers.add("Yes! Google will provide a stipend to those students who successfully complete the program. More information on the stipend can be found  <a href=\"https://developers.google.com/open-source/gsoc/help/student-stipends\">here</a>");


        studentAnswers.add("Yes, so long as the student passes his/her evaluation(s). Whether or not the project uses the produced code does not impact the student stipend.");

        studentAnswers.add("The <a href=\"https://developers.google.com/open-source/gsoc/resources/manual#student_manual\">Student Manual</a>  has a section on \"Writing a Proposal\". \n" + "The best proposals are often from students who took the time to interact and discuss their ideas with the organization before submission. Be sure to include the following: detail on exactly what you're proposing, why you're proposing it, the reason you're qualified to do it, and your development methodology. It should also include details of your academic, industry, and/or open source development experience.");


        studentAnswers.add("You are expected to spend around 30+ hours a week working on your project during the 3 month coding period. If you already have an internship, another summer job, or plan to be gone on vacation for more than a week during that time, GSoC is not the right program for you this year.");
        studentAnswers.add("Absolutely. Google can provide documentation to your school so you can obtain course credit once we receive a positive final evaluation from your mentor.");
